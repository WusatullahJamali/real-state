    ...
    <section className="bg-white py-12 text-black">
      <div className="max-w-7xl mx-auto px-6 grid gap-6 md:grid-cols-2">
        {cards.map((card, i) => (
          <div
            key={i}
            className="bg-white rounded-2xl shadow-lg flex flex-col md:flex-row items-center md:items-start p-6 md:p-8 hover:shadow-2xl transition-shadow duration-300"
          >
