...
const termsData = [
  {
    ...
    content:
      'By accessing or using the RealChoice platform (the "Service"), you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the Service. These Terms apply to all visitors, users, and others who access or use the Service.',
    icon: <Scale size={18} />,
  },
  {
    id: "accounts",
  ...
  },
  {
    ...
    content:
      "In no event shall RealChoice, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.",
  ...
  },
  {
    ...
    content:
      "These Terms shall be governed and construed in accordance with the laws of the jurisdiction in which RealChoice operates, without regard to its conflict of law provisions. Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights.",
    icon: <Gavel size={18} />,
  },
];
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-8">
              ...
              <div className="mt-8 p-6 bg-slate-50 rounded-lg border border-slate-100">
                ...
                <a
                  href="mailto:legal@realchoice.com"
          ...
          <main className="flex-1 max-w-3xl">
            ...
            <div className="mt-16 p-8 bg-slate-50 border border-slate-200 rounded-xl">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                The materials on RealChoice's website are provided on an 'as is'
                basis. RealChoice makes no warranties, expressed or implied, and
