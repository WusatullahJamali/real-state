  ...
  "FOR SALE": {
    columns: [
      ...
      },
      {
        ...
        cta: { text: "Get a Free Home Valuation", href: "/free-valuation" },
      },
    ],
  },
  "FOR RENT": {
    columns: [
      {
        ...
        items: [
          ...
          { text: "Houses for Rent", href: "/houses-for-rent", icon: House },
        ],
      },
      {
...
// --- Reusable Mega Item ---
const MegaMenuItem: React.FC<{ item: MenuItemType; onClick?: () => void }> = ({
  item,
  onClick = () => {},
}) => {
      ...
      <motion.nav className="bg-white border-b shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            <Link
              href="/add-property"
              className="relative flex items-center justify-center gap-2 px-5 py-2.5 bg-gray-900 text-white font-semibold text-sm cursor-pointer overflow-hidden shadow-md transition-all duration-300 group"
            >
          ...
          <>
            ...
            >
              ...
              <div className="mt-5 border-t pt-5 space-y-3">
                ...
                <Link
                  href="/add-property"
                  className="relative flex items-center justify-center gap-2 px-6 py-3 bg-gray-900 text-white font-semibold text-sm cursor-pointer overflow-hidden shadow-md group"
                  onClick={() => setMobileOpen(false)}
                >
