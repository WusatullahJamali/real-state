          ...
          <table className="min-w-full bg-white rounded-xl shadow overflow-hidden">
            ...
            <tbody>
              ...
              <tr className="border-b hover:bg-gray-100 transition">
                ...
                <td className="py-4 px-4">
                  Conventional loan income requirements vary by lender.
                </td>
              ...
              <tr className="border-b hover:bg-gray-100 transition">
                ...
                <td className="py-4 px-4">
                  No minimum income is required. Needs proof of steady income
              ...
              <tr className="border-b hover:bg-gray-100 transition">
                <td className="py-4 px-4">
                  <div className="mb-2">
                    ...
                    <div className="text-sm text-gray-500">
                      For homes located in a rural area.
                    </div>
                  </div>
                  <button className="bg-yellow-500 text-white py-1 px-3 rounded hover:bg-yellow-600 transition text-sm">
                    View guide
                  </button>
                </td>
                <td className="py-4 px-4">
                ...
                <td className="py-4 px-4">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    Can be no minimum but it varies by lender.
                  </div>
                </td>
                <td className="py-4 px-4">X</td>
              </tr>
              ...
              <tr className="border-b hover:bg-gray-100 transition">
                <td className="py-4 px-4">
                  <div className="mb-2">
                    ...
                    <div className="text-sm text-gray-500">
                      Only applies to Veterans or their spouses.
                    </div>
                  </div>
                  <button className="bg-yellow-500 text-white py-1 px-3 rounded hover:bg-yellow-600 transition text-sm">
                    View guide
              ...
              <tr className="border-b hover:bg-gray-100 transition">
                <td className="py-4 px-4">
                  <div>
                    <b>5/1 ARM</b>
                    <div className="text-sm text-gray-500">
                      Fixed rate for the first five years, then adjustable once
                      a year.
                    </div>
                  </div>
                </td>
