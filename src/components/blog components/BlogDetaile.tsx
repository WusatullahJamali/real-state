    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 space-y-10">
        ...
        <p className="text-lg leading-8 text-gray-700">
          ...
          driven by economic stabilization and infrastructure development.
        </p>
        ...
        {[
          {
            ...
            content:
              "Baghdad remains the center of commercial and residential activity in Iraq.",
          },
          {
            title: "Erbil’s Growing Residential Demand",
            content:
              "Erbil has emerged as one of Iraq’s most stable real estate markets.",
          },
          {
            title: "Basra’s Commercial & Oil-Driven Growth",
            content:
              "Basra’s oil-driven economy fuels strong commercial demand.",
          },
          {
            title: "Najaf & Karbala: Tourism-Based Rental ROI",
            content:
              "Religious tourism drives high rental returns in Najaf and Karbala.",
          },
        ].map((section, idx) => (
