...
export default function PromoBanner() {
  return (
    <div className="w-full bg-white flex justify-center py-6">
      <div className={"w-full max-w-6xl bg-white border border-gray-200 shadow-sm rounded-xl p-4 flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6"}>
...
<<<<<<< Updated upstream
          className="px-4 py-2 bg-yellow-500 text-white rounded-lg text-sm sm:text-base 
                     hover:bg-yellow-600 transition flex-shrink-0"
=======
          className={"px-4 py-2 bg-blue-600 text-white rounded-lg text-sm sm:text-base hover:bg-blue-700 transition flex-shrink-0"}
>>>>>>> Stashed changes
        >
          Explore Now
        </Link>
