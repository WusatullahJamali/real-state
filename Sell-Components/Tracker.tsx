...
const Tracker: React.FC<HomeValueTrackerProps> = () => {
  return (
    <div className="flex items-center justify-center bg-gray-100 pb-10 px-4">
      <div className="w-full max-w-7xl bg-white p-6 md:p-10 rounded-3xl ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
          ...
          <div className="col-span-7 flex flex-col justify-center text-center md:text-left">
            <p className="text-gray-700 w-xl text-sm md:text-base mb-4 leading-relaxed">
              Our
          ...
          <div className="col-span-5 flex justify-center">
            <div className="w-full h-60 rounded-2xl overflow-hidden shadow-xl border-2 border-gray-200">
              <iframe
